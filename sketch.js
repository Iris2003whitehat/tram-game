...
var bg;
var ground;
var boggie1,boggie2,boggie3,boggie3,boggie4,boggie5,boggie6;
...
function setup() {
  ...
  boggie4 = new Boggie(200,170,50,50);
  boggie5 = new Boggie(250,170,50,50);
  boggie6 = new Boggie(300,170,50,50);
...
function draw() {
  ...
  chain4.show();
  chain5.show();
  var collision = Matter.Set.collides(boggie6.body,rock.body);
